...
class Bet(db.Model):
    ...
    # One to Many
    bet_users = db.relationship('BetUsers', lazy=True, cascade='all, delete-orphan')
    likes = db.relationship('Likes', lazy=True, cascade='all, delete-orphan')
    transactions = db.relationship('Transactions', lazy=True, cascade='all, delete-orphan')
